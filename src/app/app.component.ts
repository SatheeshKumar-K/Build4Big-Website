  ...
  scrollTo(sectionId: string, event?: Event): void {
    ...
    const performScroll = (id: string) => {
      ...
      if (el) {
        ...
        const targetScrollY = Math.max(0, Math.round(top - headerHeight));
...
@Component({
  ...
  styles: `
    ...
    @media (min-width: 1920px) {
      ...
      .foot p, .foot-nav a, .foot section > a { font-size: 14.5px; }
      .copyright { font-size: 13px; padding: 24px 36px; }
    }
    @media (min-width: 2560px) {
      ...
      .foot p, .foot-nav a, .foot section > a { font-size: 16px; }
      .copyright { font-size: 14.5px; padding: 28px 48px; }
    }
...
@Component({
  ...
  styles: `
    ...
    .showcase-title {
      font: 800 clamp(24px, 2.6vw, 34px)/1.15 Manrope, sans-serif;
    ...
    .service-card {
      ...
      box-shadow: 0 12px 30px rgba(22, 45, 96, 0.08);
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    .service-card.is-active {
      box-shadow: 0 28px 56px -12px rgba(37, 99, 235, 0.32),
    ...
    @keyframes bubbleFloat {
      0%, 100% { transform: translateZ(32px) translateY(-2px) scale(1); filter: drop-shadow(0 4px 12px rgba(37, 99, 235, 0.35)); }
      50% { transform: translateZ(36px) translateY(-6px) scale(1.05); filter: drop-shadow(0 8px 20px rgba(37, 99, 235, 0.55)); }
    }

    /* Card Typography */
    .service-card h3 {
      font: 800 16.5px/1.2 Manrope, sans-serif;
      color: #081236;
      margin: 0 0 6px;
...
@Component({
  ...
  styles: `
    ...
    .sol-showcase-title {
      font: 800 clamp(22px, 2.3vw, 29px)/1.12 'Manrope', sans-serif;
      letter-spacing: -0.04em;
      margin: 0 0 4px;
      color: #0a1128;
    }
    ...
    .sol-ecosystem-row {
      display: grid;
      grid-template-columns: 260px 380px 260px;
      gap: 20px;
      align-items: center;
      justify-content: center;
      width: 100%;
    ...
    .sol-feature-card {
      ...
      align-items: center;
      gap: 10px;
      box-shadow: 0 6px 18px rgba(15, 23, 42, 0.04), 0 1px 2px rgba(0, 0, 0, 0.02);
      transform-style: preserve-3d;
      transition: transform 0.28s ease, box-shadow 0.28s ease, border-color 0.28s ease;
      cursor: pointer;
      position: relative;
    }
    .sol-col-left .sol-feature-card {
      transform: perspective(700px) rotateY(4deg);
    }
    .sol-col-right .sol-feature-card {
      transform: perspective(700px) rotateY(-4deg);
    }
    .sol-col-left .sol-feature-card:hover,
    .sol-col-left .sol-feature-card.is-active,
    .sol-col-right .sol-feature-card:hover,
    .sol-col-right .sol-feature-card.is-active {
      transform: perspective(700px) rotateY(0deg) translateY(-4px) translateZ(16px) scale(1.02);
      border-color: var(--card-accent);
      box-shadow: 0 16px 36px -8px var(--card-glow), 0 0 0 1.5px var(--card-accent);
    }
    .card-icon-squircle {
      width: 36px;
      height: 36px;
    ...
    .sol-feature-card:hover .card-icon-squircle {
    ...
    .card-heading {
      font: 700 12.5px/1.25 'Plus Jakarta Sans', 'Manrope', sans-serif;
      color: #0f172a;
      margin: 0 0 2px 0;
    }
    .card-desc {
      font: 400 10.5px/1.35 'Inter', sans-serif;
      color: #64748b;
      margin: 0;
      white-space: normal;
    }
    ...
    /* CENTER: Orbital Stage (compact to fit viewport) */
    .sol-orbital-col {
      display: flex;
      justify-content: center;
      align-items: center;
    ...
    /* Central Fixed AI Core in 3D Space */
    .center-ai-core {
      position: absolute;
      left: 50%;
      top: 50%;
    ...
    .center-core-body {
      ...
      box-shadow: 0 0 30px rgba(0, 195, 255, 0.6),
                  inset 0 0 20px rgba(0, 225, 255, 0.35),
                  0 18px 40px rgba(2, 9, 30, 0.75);
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
      ...
      box-sizing: border-box;
      z-index: 2;
      animation: coreBob3D 4s ease-in-out infinite alternate;
    }
    @keyframes coreBob3D {
    ...
    .robot-avatar-wrap {
      ...
      height: 24px;
      margin-bottom: 2px;
      filter: drop-shadow(0 2px 6px rgba(0, 210, 255, 0.5));
    }
    .robot-svg {
      width: 100%;
      height: 100%;
    ...
    .core-ai-text {
      font: 900 14px/1 'Plus Jakarta Sans', sans-serif;
    ...
    /* Orbiting Node Slots: radius is 195 * (370 / 520) = 138.75px */
    .orbit-node-slot {
      position: absolute;
      top: 50%;
      left: 50%;
      width: 0;
      height: 0;
      transform: rotate(var(--node-angle)) translateY(-139px);
      z-index: 5;
    }
    ...
    .orbit-pod-bubble {
      ...
      box-shadow: 0 0 16px var(--node-glow), 0 6px 14px rgba(15, 23, 42, 0.08);
      display: flex;
      flex-direction: column;
      align-items: center;
      justify-content: center;
    ...
    .orbit-pod-bubble.is-hovered {
      ...
      box-shadow: 0 0 24px var(--node-color), 0 8px 18px rgba(15, 23, 42, 0.14);
    }
    .pod-icon-wrap {
      width: 22px;
      height: 22px;
    ...
    @media (min-width: 1920px) {
      ...
      .orbit-node-slot { transform: rotate(var(--node-angle)) translateY(-165px); }
      .counter-rotate-wrap { width: 88px; height: 88px; margin-left: -44px; margin-top: -44px; }
      .orbit-pod-bubble { width: 84px; height: 84px; }
      .pod-svg { width: 24px; height: 24px; }
      .pod-label { font-size: 9.5px; max-width: 72px; }
      .center-ai-core { width: 130px; height: 130px; }
    ...
    @media (min-width: 2400px) {
      ...
      .counter-rotate-wrap { width: 100px; height: 100px; margin-left: -50px; margin-top: -50px; }
      .orbit-pod-bubble { width: 96px; height: 96px; }
      .pod-svg { width: 28px; height: 28px; }
      .pod-label { font-size: 11px; max-width: 84px; }
    ...
    @media (max-width: 1180px) {
      .sol-ecosystem-row {
        grid-template-columns: 240px 350px 240px;
        gap: 16px;
      }
      .orbital-stage {
        width: 350px;
      ...
      .orbit-node-slot {
        transform: rotate(var(--node-angle)) translateY(-131px);
      }
      .counter-rotate-wrap {
        width: 72px;
        height: 72px;
    ...
    @media (max-width: 1024px) {
      ...
      .orbit-node-slot {
        transform: rotate(var(--node-angle)) translateY(-128px);
      }
      .counter-rotate-wrap {
        width: 70px;
        height: 70px;
    ...
    @media (max-width: 768px) {
      ...
      .orbit-node-slot {
        transform: rotate(var(--node-angle)) translateY(-112px);
      }
      .counter-rotate-wrap {
        width: 66px;
        height: 66px;
...
@Component({
  ...
  styles: `
    ...
    .story-card{position:relative;flex:0 0 240px;min-height:230px;padding:22px 20px;border:1px solid #ffffffc9;border-radius:20px;background:linear-gradient(145deg,#f8fbffcf,#dbe7ffcc);box-shadow:0 14px 34px #1b478c16;backdrop-filter:blur(12px);transform-style:preserve-3d;transition:transform .35s cubic-bezier(.2,.8,.2,1),box-shadow .35s ease,border-color .35s ease}
    .story-card:hover{transform:perspective(700px) rotateY(-5deg) rotateX(4deg) translateY(-8px) translateZ(22px) !important;box-shadow:0 24px 48px #1c4baa32,0 0 26px rgba(38,96,249,0.22);border-color:#2660f980}
    .card-count{color:#6276ae;font-size:12px;transform:translateZ(12px)}
    .card-icon{float:right;display:grid;place-items:center;width:44px;height:44px;border-radius:14px;background:linear-gradient(145deg,#725aff,#06c8e9);color:#fff;font-size:20px;box-shadow:0 8px 18px #3b66e555;transform:translateZ(26px);transition:transform 0.3s ease;animation:cardIconBob 3.6s ease-in-out infinite}
    .story-card:hover .card-icon{transform:translateZ(38px) scale(1.12);box-shadow:0 12px 26px #3b66e577}
    @keyframes cardIconBob{0%,100%{transform:translateY(0)}50%{transform:translateY(-4px) scale(1.06)}}
    .story-card h3{font:800 24px Manrope;letter-spacing:-.05em;margin:44px 0 6px;transform:translateZ(18px)}
    .story-card p{color:#58698f;font-size:12.5px;line-height:1.5;margin:0;max-width:195px;transform:translateZ(14px)}
    .card-arrow{position:absolute;bottom:20px;left:20px;display:grid;place-items:center;width:34px;height:34px;border-radius:50%;color:#2660f9;background:#fff;box-shadow:0 4px 10px #27428624;font-size:18px;transform:translateZ(20px);transition:all .25s ease}
    .story-card:hover .card-arrow{transform:translateZ(28px) translateX(4px);background:#2660f9;color:#fff;box-shadow:0 6px 14px #2660f944}
    ...
    @media (min-width: 1920px) {
      ...
      .about-hero { gap: 40px; }
      .story-copy { padding: 32px 34px; border-radius: 24px; }
      .story-copy h3 { font-size: 25px; }
      .story-copy p { font-size: 15px; }
      .story-card { flex: 0 0 280px; min-height: 260px; padding: 26px 24px; }
    ...
    @media(max-width:560px){.about-page{padding:24px 0}.about-head-title{font-size:clamp(22px,6.5vw,28px)}.about-head-sub{font-size:12.5px;padding:0 8px}.story-copy{padding:18px 16px}.story-card{flex-basis:220px;min-height:210px;padding:16px}.card-marquee{width:100%;margin:0;mask-image:none}.edge{display:none}}
...
@Component({
  ...
  styles: `
    ...
    @media (max-width: 767px) {
      ...
      .scribble { display: none; }
      .plane-wrap { display: none; }
      .cpillar, .contact-form-card { transform: none !important; }
    }
  `,
})
...
@Component({
  ...
  styles: `
    ...
    .hero-cyber-grid {
      ...
      animation: gridDrift3D 20s linear infinite;
      opacity: 0.65;
    }
    @keyframes gridDrift3D {
    ...
    .hero-pill-badge {
      ...
      box-shadow: 0 4px 16px rgba(0, 140, 255, 0.2);
    }
    .pill-dot {
      width: 6px;
      height: 6px;
    ...
    .hero-headline {
      font: 800 clamp(32px, 3.4vw, 48px)/1.12 'Manrope', sans-serif;
      letter-spacing: -0.04em;
      margin: 0 0 14px;
      color: #ffffff;
      text-shadow: 0 4px 30px rgba(0, 8, 40, 0.8);
    }
    ...
    .btn-hero-gradient:hover {
      transform: translateY(-2px);
      box-shadow: 0 12px 30px rgba(0, 160, 255, 0.65);
    }
    .btn-hero-glass {
    ...
    .mark-img-4b {
      ...
      height: 120px;
      object-fit: contain;
      filter: drop-shadow(0 0 24px rgba(0, 220, 255, 0.95)) drop-shadow(0 0 10px rgba(0, 110, 255, 0.95));
      user-select: none;
      pointer-events: none;
    }
    @keyframes markBob {
    ...
    .node-1 { top: 10px; left: 50px; animation-delay: 0.2s; }
    .node-2 { top: 22px; right: 30px; animation-delay: 1.1s; }
    .node-3 { bottom: 25px; left: 40px; animation-delay: 0.7s; }
    .node-4 { bottom: 30px; right: 35px; animation-delay: 1.6s; }
    @keyframes nodeFloat {
      0%, 100% { transform: translateY(0); }
    ...
    .chip-ai { top: 10px; left: 0; transform: translate3d(0, 0, 52px); }
    .chip-innovation { top: 15px; right: 0; transform: translate3d(0, 0, 36px); }
    .chip-strategy { bottom: 20px; left: 0; transform: translate3d(0, 0, 56px); }
    .chip-support { bottom: 28px; right: 5px; transform: translate3d(0, 0, 42px); }

    .glass-chip {
      background: rgba(10, 28, 80, 0.82);
      backdrop-filter: blur(20px);
      -webkit-backdrop-filter: blur(20px);
      border: 1.5px solid rgba(0, 190, 255, 0.45);
      border-radius: 14px;
      padding: 8px 12px;
      display: flex;
      align-items: center;
    ...
    .glass-chip:hover {
      border-color: #00e1ff;
      box-shadow: 
        0 22px 55px rgba(0, 150, 255, 0.55),
        0 0 30px rgba(0, 225, 255, 0.5),
        inset 0 1px 0 rgba(255, 255, 255, 0.4);
      transform: translateZ(24px) scale(1.06) !important;
    }
    .glass-chip .chip-icon {
      transform: translateZ(14px);
    }
    .glass-chip .chip-text-wrap {
      transform: translateZ(10px);
    }
    ...
    .hero-marquee-bar {
      ...
      padding: 7px 0;
      overflow: hidden;
      box-shadow: 0 12px 30px rgba(1, 6, 24, 0.7);
      user-select: none;
    }
    .marquee-edge {
      position: absolute;
    ...
    @media (max-width: 768px) {
      ...
      .ring-1 { width: 320px; height: 180px; }
      .ring-2 { width: 330px; height: 160px; }
      .ring-3 { width: 250px; height: 250px; }
      .orbit-glow-behind { width: 260px; height: 260px; }
      .glass-chip {
        min-width: 145px;
        padding: 8px 12px;
        gap: 8px;
    ...
    @media (max-width: 480px) {
      ...
      .ring-1 { width: 260px; height: 150px; }
      .ring-2 { width: 270px; height: 130px; }
      .ring-3 { width: 200px; height: 200px; }
      .orbit-glow-behind { width: 220px; height: 220px; }
      .glass-chip {
        min-width: 120px;
        padding: 6px 9px;
        border-radius: 12px;
    ...
    @media (max-width: 360px) {
      ...
      .ring-1 { width: 220px; height: 120px; }
      .ring-2 { width: 230px; height: 110px; }
      .ring-3 { width: 170px; height: 170px; }
      .orbit-glow-behind { width: 170px; height: 170px; }
      .glass-chip {
        min-width: 105px;
        padding: 5px 7px;
      }
